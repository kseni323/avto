...
<body>
  ...
  <details class="accordion">
    ...
    <p>- Запрещается использовать ТС вне дорог общего пользования, на пересеченной местности, для преодоления водных преград, в лесу;
        ...
        - Субаренда и иная передача Арендатором ТС третьим лицам запрещена;
        - Запрещается производить разборку и ремонт ТС, а так же производить вмешательство в конструкцию ТС и устанавливать дополнительное оборудование;
        - Запрещается вождение ТС в состоянии алкогольного, наркотического, токсического опьянения.</p>
  </details>
